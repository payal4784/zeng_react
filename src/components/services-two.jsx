    ...
    <div className='container relative'>
        <div className="grid grid-cols-1 text-center mb-6">
            <div>
                ...
                <h2 className='mb-4 title lg:w-1/2 w-full mx-auto !text-white'>Custom IT Solutions for Your Successful Business</h2>
            </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.slice(0,4).map((item,index)=>{
                let Icon= item.icon
                return(
                    <div className='group text-center bg-white rounded relative transition duration-1000'>
