...
export default function NavLight() {
  ...
  return (
    <>
      <nav className={`navbar navlight tagline ${scroll ? 'is-sticky' : ''}`}>
          ...
          <div className={`nav-manu md:block ${toggle ? '' : 'hidden'}`}>
            ...
            <li className={`nav-link ${['/','/home-2','/home-3'].includes(currentPath) ? 'active' : ''}`}> <span>Home</span>
              <ul className='submenu open'>
                ...
                <li className={`nav-link2 ${currentPath === '/home-3' ? 'active' : ''}`}><Link to="/home-3">Home-4</Link></li>
                <li className={`nav-link2 ${currentPath === '/home-3' ? 'active' : ''}`}><Link to="/home-3">Home-5</Link></li>
                <li className={`nav-link2 ${currentPath === '/home-3' ? 'active' : ''}`}><Link to="/home-3">Home-6</Link></li>
                <li className={`nav-link2 ${currentPath === '/home-3' ? 'active' : ''}`}><Link to="/home-3">Home-7</Link></li>
              </ul>
            </li>
